...
const SLIDES = [
  {
    id: 0,
    Room: LivingRoom,
    heading: 'Скандинавский интерьер',
    sub: 'Светлые тона, натуральные материалы, функциональность без лишнего.',
    slug: 'skandinavsky',
    tags: [
    ...
    cats: [
      { label: 'Мебель',     count: '3 товара', to: '/collections/skandinavsky' },
      { label: 'Освещение',  count: '2 товара', to: '/collections/skandinavsky' },
      { label: 'Сантехника', count: '2 товара', to: '/collections/skandinavsky' },
    ],
  },
  {
    id: 1,
    Room: LightingRoom,
    heading: 'Japandi',
    sub: 'Японская сдержанность и скандинавский уют. Дерево, лён, матовые поверхности.',
    slug: 'japandi',
    tags: [
    ...
    cats: [
      { label: 'Мебель',     count: '2 товара', to: '/collections/japandi' },
      { label: 'Освещение',  count: '2 товара', to: '/collections/japandi' },
      { label: 'Сантехника', count: '2 товара', to: '/collections/japandi' },
    ],
  },
  {
    id: 2,
    Room: BathroomRoom,
    heading: 'Минимализм',
    sub: 'Только нужное. Чистые формы, нейтральная палитра, материалы с характером.',
    slug: 'minimalizm',
    tags: [
    ...
    cats: [
      { label: 'Мебель',     count: '3 товара', to: '/collections/minimalizm' },
      { label: 'Освещение',  count: '2 товара', to: '/collections/minimalizm' },
      { label: 'Сантехника', count: '1 товар',  to: '/collections/minimalizm' },
    ],
  },
]
