...
[Plan 5: Home]             ← МЫ ЗДЕСЬ — следующее
```

**Следующее действие:** написать Plan 5 (Home). Использовать `superpowers:brainstorming` → `superpowers:writing-plans`.
...
**Сейчас:** Plan 5 (Home) — следующий.
- Scope: Hero rebuild + все секции главной страницы
